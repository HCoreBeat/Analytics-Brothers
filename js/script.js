class SalesDashboard {
            ...
            <div class="summary-card">
                ...
                <div class="summary-grid">
                    <div class="summary-item highlight">
                        <div class="stat-value"><span class="zelle-icon"></span>${currentPeriodData.sales.toLocaleString('en-US', {minimumFractionDigits: 2, maximumFractionDigits: 2})}</div>
    ...
    renderWeeklySummary() {
        ...
        container.innerHTML = `
            <div class="summary-item">
                ...
                <div class="stat-value"><span class="zelle-icon"></span>${todaySales.toFixed(2)}</div>
                <div class="stat-label">${todayOrders.length} pedidos</div>
            </div>
            <div class="summary-item">
                <h4><i class="fas fa-moon"></i> Ayer</h4>
                <div class="stat-value"><span class="zelle-icon"></span>${yesterdaySales.toFixed(2)}</div>
    ...
    updateStats(data) {
        ...
        let totalSalesZelle = 0;
        data.forEach(order => {
            totalSalesZelle += parseFloat(order.precio_compra_total) || 0;
        });
        document.getElementById('total-sales-zelle').innerHTML = `<span class="zelle-icon"></span>${totalSalesZelle.toLocaleString('en-US', {minimumFractionDigits: 2, maximumFractionDigits: 2})}`;
                ...
                <div class="order-card">
                    <div class="order-header">
                        ...
                        <div class="order-stats">
                            <div class="stat-value"><span class="zelle-icon"></span>${(parseFloat(order.precio_compra_total) || 0).toLocaleString('en-US', {minimumFractionDigits: 2, maximumFractionDigits: 2})}</div>
                        ...
                        <div class="products-list">
                            ${order.compras.map(product => `
                                <div class="product-item">
                                    ...
                                    <span>${product.quantity} × <span class="zelle-icon"></span>${(product.unitPrice || 0).toLocaleString('en-US', {minimumFractionDigits: 2, maximumFractionDigits: 2})}</span>
